---
title: "MELIKA Architecture: API, Client, and Database Design"
sidebarTitle: "Architecture"
description: "How MELIKA's React frontend, Express API, and PostgreSQL database connect — covering the auth flow, route table, and full database schema."
---
